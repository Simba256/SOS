...
T? getParameter<T>(Map<String, dynamic> data, String paramName) {
  try {
    ...
    switch (T) {
      ...
      case ReadContactsRow:
        return ReadContactsRow(json.decode(param) as Map<String, dynamic>) as T;
      case ReadPhoneNumbersRow:
        return ReadPhoneNumbersRow(json.decode(param) as Map<String, dynamic>)
            as T;
      case SearchContactsRow:
        return SearchContactsRow(json.decode(param) as Map<String, dynamic>)
            as T;
    }
    if (param is String) {
