...
import 'profile_v2_model.dart';
export 'profile_v2_model.dart';

class ProfileV2Widget extends StatefulWidget {
  const ProfileV2Widget({super.key});

  static String routeName = 'ProfileV2';
  static String routePath = '/profileV2';
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          ...
                          if (selectedMedia != null &&
                            ...
                            safeSetState(() =>
                                _model.isDataUploading_uploadData06v = true);
                            ...
                            try {
                              ...
                              _model.isDataUploading_uploadData06v = false;
                            }
