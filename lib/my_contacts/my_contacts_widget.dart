...
class MyContactsWidget extends StatefulWidget {
  ...
  static String routeName = 'MyContacts';
  static String routePath = '/myContacts';

  @override
  State<MyContactsWidget> createState() => _MyContactsWidgetState();
}
  ...
  void initState() {
    ...
    _model.textFieldFocusNode!.addListener(
      () async {
        ...
        safeSetState(() {});
        safeSetState(() {
          _model.textController?.text = _model.search!;
        });
      },
    );
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(103.17),
                      border: Border.all(
                    ...
                    child: Container(
                      ...
                      child: FutureBuilder<List<SearchContactsRow>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          final listViewSearchContactsRowList = snapshot.data!;

                          return ListView.builder(
                            padding: EdgeInsets.zero,
                            scrollDirection: Axis.vertical,
                            itemCount: listViewSearchContactsRowList.length,
                            itemBuilder: (context, listViewIndex) {
                              final listViewSearchContactsRow =
                                  listViewSearchContactsRowList[listViewIndex];
                              return Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    17.5, 10.0, 17.5, 10.0),
                                child: Container(
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              listViewSearchContactsRow.name,
                                          ...
                                          child: FlutterFlowIconButton(
                                            ...
                                            onPressed: () async {
                                              await SQLiteManager.instance
                                                ...
                                                name: listViewSearchContactsRow
                                                    .name,
                                              );
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  context
                                      .pushNamed(AppsettingsWidget.routeName);
                                },
                                child: Container(
                                  height:
                                      MediaQuery.sizeOf(context).height * 0.08,
