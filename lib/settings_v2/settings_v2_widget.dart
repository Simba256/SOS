...
import 'settings_v2_model.dart';
export 'settings_v2_model.dart';

class SettingsV2Widget extends StatefulWidget {
  const SettingsV2Widget({super.key});

  static String routeName = 'SettingsV2';
  static String routePath = '/settingsV2';

  @override
  State<SettingsV2Widget> createState() => _SettingsV2WidgetState();
}

class _SettingsV2WidgetState extends State<SettingsV2Widget> {
  late SettingsV2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SettingsV2Model());
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(14.0, 22.0, 14.0, 0.0),
                child: Column(
                  mainAxisSize: MainAxisSize.max,
                  children: [
                    Align(
