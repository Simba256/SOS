...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: HomeV2Widget.routeName,
          path: HomeV2Widget.routePath,
          builder: (context, params) => HomeV2Widget(),
        ),
        FFRoute(
          name: ContactsV2Widget.routeName,
          path: ContactsV2Widget.routePath,
          builder: (context, params) => ContactsV2Widget(),
        ),
        FFRoute(
          name: Sosv2Widget.routeName,
          path: Sosv2Widget.routePath,
          builder: (context, params) => Sosv2Widget(),
        ),
        FFRoute(
          name: SettingsV2Widget.routeName,
          path: SettingsV2Widget.routePath,
          builder: (context, params) => SettingsV2Widget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: LoadContactsV2Widget.routeName,
          path: LoadContactsV2Widget.routePath,
          builder: (context, params) => LoadContactsV2Widget(),
        ),
        FFRoute(
          name: ProfileV2Widget.routeName,
          path: ProfileV2Widget.routePath,
          builder: (context, params) => ProfileV2Widget(),
        ),
        FFRoute(
